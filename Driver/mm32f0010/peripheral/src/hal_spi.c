...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void HAL_SPI_Init(SPI_TypeDef* spi, SPI_InitTypeDef* init_struct)
{
...
{
/*ting.gao 2021/2/22, there are weird phenomenon for this recv function:
  add or delete unused code may cause recv wrong data. so we temporally
  close this 32bit recv function, use 8bit recv function instead*/
#if 0
    u32 temp;
    u8 templen;
    __asm volatile("cpsid i");
