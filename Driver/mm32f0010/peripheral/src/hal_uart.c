...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void HAL_UART_Init(UART_TypeDef* uart, UART_InitTypeDef* init_struct)
{
    u32 apbclock = 0x00;
...
{
    if(value == Data_F8) {
        WRITE_REG(uart->ABRCR, UART_ABRCR_LATTER | UART_ABRCR_BITCNT_2 | (UART_ABRCR_ABREN & state));
    }
    else {
        WRITE_REG(uart->ABRCR, UART_ABRCR_FORMER | UART_ABRCR_BITCNT_2 | (UART_ABRCR_ABREN & state));
    }
}
/// @}
