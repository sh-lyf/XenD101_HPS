...
================================================================================
  ...
  [..]
      The PY32F003 device family integrates two analog comparators instances:
      COMP1, COMP2.
...
HAL_StatusTypeDef HAL_COMP_Init(COMP_HandleTypeDef *hcomp)
{
    ...
    else
    {
        ...
        MODIFY_REG(hcomp->Instance->CSR,
                   ...
                   COMP_CSR_POLARITY | COMP_CSR_WINMODE | COMP_CSR_INPSEL | COMP_CSR_INMSEL |
                   COMP_CSR_SCALER_EN | COMP_CSR_EN,
                   tmp_csr
                  );
