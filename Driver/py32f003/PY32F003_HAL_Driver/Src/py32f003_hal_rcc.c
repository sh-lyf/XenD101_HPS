...
//    RCC->PLLCFGR = 0x00000000u;//RCC_PLLCFGR_PLLN_4;
...
//        temp_pllckcfg = __HAL_RCC_GET_PLL_OSCSOURCE();
        ...
        {
            SET_BIT(RCC->ECSCR, RCC_ECSCR_HSE_FREQ);//LSQ
...
//            if (__HAL_RCC_PWR_IS_CLK_DISABLED() != 0U)    //no Backup domain
//            {
...
/**
  ...
  *          For PY32F003 family this parameter can have only one value:
...
/**
  ...
  * @note     (*) HSI_VALUE is a constant defined in py32f003_hal_conf.h file (default value
  *               16 MHz) but the real value may vary depending on the variations
  *               in voltage and temperature.
  * @note     (**) HSE_VALUE is a constant defined in py32f003_hal_conf.h file (default value
  *                8 MHz), user has to ensure that HSE_VALUE is same as the real
  *                frequency of the crystal used. Otherwise, this function may
  *                have wrong result.
  * @note     (***) LSE_VALUE is a constant defined in py32f003_hal_conf.h file (default value
  *               32768 Hz).
  * @note     (****) LSI_VALUE is a constant defined in py32f003_hal_conf.h file (default value
  *               32000 Hz).
  *
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef  *RCC_OscInitStruct)
{
    ...
    RCC_OscInitStruct->HSICalibrationValue = ((RCC->ICSCR & RCC_ICSCR_HSI_TRIM) >> RCC_ICSCR_HSI_TRIM_Pos);
